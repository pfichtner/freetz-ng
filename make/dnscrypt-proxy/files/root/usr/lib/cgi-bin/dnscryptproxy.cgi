...
check "$DNSCRYPTPROXY_LOG_SYSLOG" yes:log_syslog_yes "*":log_syslog_no

sec_begin "$(lang de:"Starttyp" en:"Start type")"
cgi_print_radiogroup_service_starttype "enabled" "$DNSCRYPTPROXY_ENABLED" "" "" 1
sec_end
...
<input type="text" id="bindaddress" name="bindaddress" value="$(html "$DNSCRYPTPROXY_BINDADDRESS")">
...
<input type="text" name="log_file" size="45" maxlength="255" value="$(html "$DNSCRYPTPROXY_LOG_FILE")"></label>
</p>
EOF
sec_end
